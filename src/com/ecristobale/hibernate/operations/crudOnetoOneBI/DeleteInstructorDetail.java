	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			if(myInstructorDetail != null) {
				...
				System.out.println("3. InstructorDetail deleted with id = " + id);
			} else {
				System.out.println("3. No InstructorDetail found in database for the id: " + id);
			}
			
			// commit transaction from session
			session.getTransaction().commit();

			System.out.println("4. Transaction commited.");
